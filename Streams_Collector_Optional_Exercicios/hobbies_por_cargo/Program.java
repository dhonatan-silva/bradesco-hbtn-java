...
public class Program {
	...
	public static void main(String[] args) {
		...
		Map<String, TreeSet<String>> pessoas2 = ConsultaPessoas.obterHobbiesPorCargo(List.of(pessoa1, pessoa2, pessoa3, pessoa4, pessoa9, pessoa10));
		Map<String, TreeSet<String>> pessoas3 = ConsultaPessoas.obterHobbiesPorCargo(List.of(pessoa1, pessoa3, pessoa4, pessoa5, pessoa9));
