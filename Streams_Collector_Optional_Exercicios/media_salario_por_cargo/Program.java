...
public class Program {
	...
	public static void main(String[] args) {
		...
		Map<String, Double> pessoas2 = ConsultaPessoas.obterMediaSalarioPorCargo(List.of(pessoa1, pessoa2, pessoa3, pessoa4, pessoa9, pessoa10));
		Map<String, Double> pessoas3 = ConsultaPessoas.obterMediaSalarioPorCargo(List.of(pessoa1, pessoa3, pessoa4, pessoa5, pessoa9));
