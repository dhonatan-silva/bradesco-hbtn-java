...
public class Program {
	...
	public static void main(String[] args) {
		...
		Map<String, Long> pessoas2 = ConsultaPessoas.obterContagemPessoasPorCargo(List.of(pessoa1, pessoa2, pessoa3, pessoa4, pessoa9, pessoa10));
		Map<String, Long> pessoas3 = ConsultaPessoas.obterContagemPessoasPorCargo(List.of(pessoa1, pessoa3, pessoa4, pessoa5, pessoa9));
